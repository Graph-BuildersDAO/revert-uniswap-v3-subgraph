...
export class FeeTierToTickSpacing extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save FeeTierToTickSpacing entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type FeeTierToTickSpacing must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("FeeTierToTickSpacing", id.toString(), this);
    }
  }

  static loadInBlock(id: string): FeeTierToTickSpacing | null {
    return changetype<FeeTierToTickSpacing | null>(
      store.get_in_block("FeeTierToTickSpacing", id),
    );
  }

  static load(id: string): FeeTierToTickSpacing | null {
    return changetype<FeeTierToTickSpacing | null>(
      store.get("FeeTierToTickSpacing", id),
    );
  }
...
export class Token extends Entity {
  ...
  get tokenTimeseries(): TokenTimeseriesLoader {
    return new TokenTimeseriesLoader(
      "Token",
...
export class Pool extends Entity {
  ...
  get poolTimeseries(): PoolTimeseriesLoader {
    return new PoolTimeseriesLoader(
      "Pool",
      this.get("id")!.toBytes().toHexString(),
      "poolTimeseries",
    );
...
export class Position extends Entity {
  ...
  set tickLower(value: Bytes) {
    this.set("tickLower", Value.fromBytes(value));
  }
  ...
  set tickUpper(value: Bytes) {
    this.set("tickUpper", Value.fromBytes(value));
  }
...
export class UniswapData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save UniswapData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type UniswapData must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("UniswapData", id.toString(), this);
    }
  }

  static loadInBlock(id: string): UniswapData | null {
    return changetype<UniswapData | null>(
      store.get_in_block("UniswapData", id),
    );
  }

  static load(id: string): UniswapData | null {
    return changetype<UniswapData | null>(store.get("UniswapData", id));
  }
...
export class PoolData extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type PoolData must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("PoolData", id.toString(), this);
    }
  }

  static loadInBlock(id: string): PoolData | null {
    return changetype<PoolData | null>(store.get_in_block("PoolData", id));
  }

  static load(id: string): PoolData | null {
    return changetype<PoolData | null>(store.get("PoolData", id));
  }
...
export class TickData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save TickData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type TickData must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("TickData", id.toString(), this);
    }
  }

  static loadInBlock(id: string): TickData | null {
    return changetype<TickData | null>(store.get_in_block("TickData", id));
  }

  static load(id: string): TickData | null {
    return changetype<TickData | null>(store.get("TickData", id));
  }
...
export class TokenTimeseriesLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): TokenTimeseries[] {
    let value = store.loadRelated(this._entity, this._id, this._field);
    return changetype<TokenTimeseries[]>(value);
  }
}

export class PoolTimeseriesLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): PoolTimeseries[] {
    let value = store.loadRelated(this._entity, this._id, this._field);
    return changetype<PoolTimeseries[]>(value);
  }
}
